...
notDec:  ADDA    0x0030,i    ;convert back to ascii char
         ...
         BREQ    postFix     ;;PostCalc after this
...
postFix: LDWA    vecI,d      ;Resets vecI to parse through array
...
ifLoops: LDWX    vecI,d      ;load inVec index
         ...
         STWA    value,d     
         CPWA    0,i
         BREQ    end         ;;Can output stack from here for answer
...
addfunc: LDWA    stackin,s   ;pop
         ...
         DECO    retAdd,d    ;for testing to see result************!
...
subfunc: LDWA    stackin,s   ;pop
         ...
         DECO    retSub,d    ;for testing to see result************!
         SUBSP   2,i         ;make room for calculation on stack #stackin 
         STWA    stackin,s 
         BR      ifLoops 
